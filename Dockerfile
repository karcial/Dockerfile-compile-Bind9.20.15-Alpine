#######################################################################
#                                                                     #
#   Dockerfile : Image personnalisée BIND 9.20.15 sur Alpine Linux    #
#                                                                     #
#   Objectif :                                                        #
#   - Compiler BIND 9 depuis les sources avec options avancées        #
#   - Créer une image légère et sécurisée pour serveur DNS            #
#   - Inclure support DNSSEC, dnstap, LMDB, MaxMindDB                 #
#                                                                     #
#   Utilisation :                                                     #
#   docker build -t custom-bind:9.20.15 .                             #
#   docker run -d --name bind-server \                                #
#       -v /etc/bind:/etc/bind \                                      #
...
COPY bind/config/named.conf /etc/bind
